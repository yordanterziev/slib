...
/**
 * This class builds a tree structure containing a semantic correct path through
 * an ontology. It contains Nodes of the class {@link SrNode}. The tree
 * maintains the semantic correct path by removing the incorrect Node
 * immediately. All nodes can be accessed instantly via a HashMap, because the
 * tree is likely to be unbalanced. The tree does not take care of duplicate
 * values and cycles.
 * 
...
public class SrTree {
	...
	/**
	 * Creates the tree by setting a root and the lists of Upward, Downward and
	 * Horizontal Edges.
	 * 
	 * @param root
	 *            root of the tree
	 * @param uEdges
	 *            list of upward edges.
	 * @param dEdges
	 *            list of downward edges.
	 * @param hEdges
	...
	/**
	 * Removes the given Node. The entire tree will be removed, if the root is
	 * given.
	 * 
	 * @param data
	 *            URI of the given Node
	 */
	...
	/**
	 * Adds Elements to the tree. The Elements are retrieved from a List of
	 * Edges. Data is set to target. Parent is set to source. Maps are
	 * maintained The semantic path is extended.
	 * 
	 * @param list
	 *            list of Edges
	 * @param level
	 *            at which the children are put.
	 */
